...
export declare function errorResponse(errors: ToolErrorItem[]): ToolErrorResponse;
export declare function singleError(field: string, expected: string, actual: string, hint: string): ToolErrorResponse;
...
export interface StorylineRow {
    ...
    id: string;
    name: string;
    type: "main" | "growth" | "romance" | "faction" | "mystery" | "rivalry" | "world" | "other";
    priority: number;
