...
export const AUTHORING_TECHNIQUE_TAGS = ["对话设计", "心理刻画", "环境描写", "动作细节", "节奏控制", "情感渲染", "视角运用", "悬念设置"];
...
export function previewCraftCard(card) {
    ...
    const candidate = {
        ...
        priority: card.priority ?? 50, origin: "user", source_pack_id: "__draft__", source_pack_version: "0.0.0",
    };
...
export function previewPersonaCard(card) {
    ...
    const candidate = {
        ...
        origin: "user", source_pack_id: "__draft__", source_pack_version: "0.0.0",
    };
