...
const api = {
  ...
  listSkillMounts: () => ipcRenderer.invoke('skill-mounts:list'),
  setSkillMount: (mount: unknown) => ipcRenderer.invoke('skill-mounts:set', mount),
  removeSkillMount: (input: unknown) => ipcRenderer.invoke('skill-mounts:remove', input),
  resetAgentSkillMounts: (input: unknown) => ipcRenderer.invoke('skill-mounts:reset-agent', input),
  listUserSkills: () => ipcRenderer.invoke('user-skills:list'),
  previewUserSkillImport: (input: unknown) => ipcRenderer.invoke('user-skills:preview-import', input),
  commitUserSkillImport: (input: unknown) => ipcRenderer.invoke('user-skills:commit-import', input),
  uninstallUserSkill: (input: unknown) => ipcRenderer.invoke('user-skills:uninstall', input),
  readUserSkillBody: (input: unknown) => ipcRenderer.invoke('user-skills:read-body', input),
