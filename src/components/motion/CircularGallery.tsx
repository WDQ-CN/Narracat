...
// Vendored from React Bits «CircularGallery». 改动：① TypeScript 化；② 去掉远程字体加载（onboarding 用系统字体即可）；
// ③ 去掉键盘监听（避免与首次介绍的方向键推进冲突）；④ 容器样式改用 Tailwind。WebGL 引擎逻辑忠于上游。
