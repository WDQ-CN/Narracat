...
// Vendored from React Bits «Threads». 改动：TypeScript 化、容器样式改 Tailwind、命名导出、默认色改品牌绿、
// 并把线宽/线数/模糊从 shader const 提成 uniform（dev 可调）。
...
export function Threads({
  ...
  const propsRef = useRef({ color, amplitude, distance, lineCount, lineWidth, lineBlur, enableMouseInteraction })
  propsRef.current = { color, amplitude, distance, lineCount, lineWidth, lineBlur, enableMouseInteraction }
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      program.uniforms.uLineCount.value = p.lineCount
